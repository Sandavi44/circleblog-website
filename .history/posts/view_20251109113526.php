...
<body>
  ...
  <header>
    ...
    <div class="icons">
      <!-- Search icon removed from this page -->
    ...
    <ul class="navbar" id="navbar">
      ...
      <?php if (isLoggedIn()): ?>
        ...
        <li><span style="color: rgba(255,255,255,0.7);">Hello, <?php echo sanitize(getCurrentUsername()); ?>!</span></li>
      <?php else: ?>
  ...
  <!-- Search box removed from this page -->
  ...
  <article class="post-single">
    <div class="container">
      ...
      <header class="post-header">
        ...
        <a href="javascript:history.back()" class="back-to-home" title="Go Back">
        ...
        <!-- Meta section with clear separation -->
